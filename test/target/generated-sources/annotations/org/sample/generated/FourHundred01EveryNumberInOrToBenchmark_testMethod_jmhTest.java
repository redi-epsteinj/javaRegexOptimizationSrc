...
import org.sample.generated.FourHundred01EveryNumberInOrToBenchmark_jmhType;
@Generated("org.openjdk.jmh.generators.core.BenchmarkGenerator")
public final class FourHundred01EveryNumberInOrToBenchmark_testMethod_jmhTest {
    ...
    public BenchmarkTaskResult testMethod_Throughput(InfraControl control, ThreadParams threadParams) throws Throwable {
        if (threadParams.getSubgroupIndex() == 0) {
            ...
            FourHundred01EveryNumberInOrToBenchmark_jmhType l_fourhundred01everynumberinortobenchmark0_0 = _jmh_tryInit_f_fourhundred01everynumberinortobenchmark0_0(control, threadParams);
            ...
            while (control.warmupShouldWait) {
                l_fourhundred01everynumberinortobenchmark0_0.testMethod();
                res.allOps++;
            }

            testMethod_thrpt_jmhStub(control, res, l_fourhundred01everynumberinortobenchmark0_0, l_blackhole1_1);
            ...
            if (control.isLastIteration()) {
                f_fourhundred01everynumberinortobenchmark0_0 = null;
                f_blackhole1_1 = null;
            }
    ...
    public void testMethod_thrpt_jmhStub(InfraControl control, RawResults result, FourHundred01EveryNumberInOrToBenchmark_jmhType l_fourhundred01everynumberinortobenchmark0_0, Blackhole_jmhType l_blackhole1_1) throws Throwable {
        long operations = 0;
        long realTime = 0;
    ...
    public BenchmarkTaskResult testMethod_AverageTime(InfraControl control, ThreadParams threadParams) throws Throwable {
        if (threadParams.getSubgroupIndex() == 0) {
            ...
            testMethod_avgt_jmhStub(control, res, l_fourhundred01everynumberinortobenchmark0_0, l_blackhole1_1);
            control.announceWarmdownReady();
            try {
                while (control.warmdownShouldWait) {
                    l_fourhundred01everynumberinortobenchmark0_0.testMethod();
    ...
    public void testMethod_avgt_jmhStub(InfraControl control, RawResults result, FourHundred01EveryNumberInOrToBenchmark_jmhType l_fourhundred01everynumberinortobenchmark0_0, Blackhole_jmhType l_blackhole1_1) throws Throwable {
        long operations = 0;
        long realTime = 0;
        result.startTime = System.nanoTime();
        do {
    ...
    public BenchmarkTaskResult testMethod_SampleTime(InfraControl control, ThreadParams threadParams) throws Throwable {
        if (threadParams.getSubgroupIndex() == 0) {
            ...
            testMethod_sample_jmhStub(control, res, buffer, targetSamples, opsPerInv, batchSize, l_fourhundred01everynumberinortobenchmark0_0, l_blackhole1_1);
            control.announceWarmdownReady();
            try {
                while (control.warmdownShouldWait) {
                    l_fourhundred01everynumberinortobenchmark0_0.testMethod();
    ...
    public void testMethod_sample_jmhStub(InfraControl control, RawResults result, SampleBuffer buffer, int targetSamples, long opsPerInv, int batchSize, FourHundred01EveryNumberInOrToBenchmark_jmhType l_fourhundred01everynumberinortobenchmark0_0, Blackhole_jmhType l_blackhole1_1) throws Throwable {
        long realTime = 0;
        long operations = 0;
    ...
    public BenchmarkTaskResult testMethod_SingleShotTime(InfraControl control, ThreadParams threadParams) throws Throwable {
        if (threadParams.getSubgroupIndex() == 0) {
            ...
            RawResults res = new RawResults();
            int batchSize = control.iterationParams.getBatchSize();
            testMethod_ss_jmhStub(control, batchSize, res, l_fourhundred01everynumberinortobenchmark0_0, l_blackhole1_1);
            control.preTearDown();
    ...
    public void testMethod_ss_jmhStub(InfraControl control, int batchSize, RawResults result, FourHundred01EveryNumberInOrToBenchmark_jmhType l_fourhundred01everynumberinortobenchmark0_0, Blackhole_jmhType l_blackhole1_1) throws Throwable {
        long realTime = 0;
        result.startTime = System.nanoTime();
        for (int b = 0; b < batchSize; b++) {
            if (control.volatileSpoiler) return;
    ...
    FourHundred01EveryNumberInOrToBenchmark_jmhType f_fourhundred01everynumberinortobenchmark0_0;
    
    FourHundred01EveryNumberInOrToBenchmark_jmhType _jmh_tryInit_f_fourhundred01everynumberinortobenchmark0_0(InfraControl control, ThreadParams threadParams) throws Throwable {
        FourHundred01EveryNumberInOrToBenchmark_jmhType val = f_fourhundred01everynumberinortobenchmark0_0;
        if (val == null) {
            val = new FourHundred01EveryNumberInOrToBenchmark_jmhType();
            f_fourhundred01everynumberinortobenchmark0_0 = val;
        }
        return val;
    }
